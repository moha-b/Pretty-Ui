...
class AppImages {
  // Logo
  static const String lightLogo = "${logoPath}light-logo.png";
  static const String greenLogo = "${logoPath}green-logo.png";
  // Onboarding
  static const String splash = "${onboardingPath}splash-screen.png";
